...
const Topbar = () => {
  ...
  <div className="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden">
    ...
    <div className="flex w-full items-center justify-between">
      ...
      <div className="size-7">
        {/* <button className="sidebar-toggle ml-0.5 flex size-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80">
          <span />
        
          <span />
          <span />
        </button> */}
        <button className="sidebar-toggle ml-[5rem] flex size-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80">
    <svg
    ...
    >
      ...
      <div className=" flex items-center justify-end space-x-2 ml-[40rem]">
        ...
        <div id="searchbar-wrapper" className="hidden sm:flex">
          <div className="relative mr-4 flex h-8">
            <input id="searchbar-ref" placeholder="Search here..." className="form-input peer h-full w-60 rounded-full bg-slate-150 px-4 pl-9 text-xs+ text-slate-800 ring-primary/50 bg-slate-200 focus:ring dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" />
            <div className="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-4 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Dark Mode Toggle */}
         ...
         <button
      className="darkmode-toggle btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
 ...
 {/* Notification*/}
   ...
   <button
        id="notification-ref"
        className="btn relative size-8 rounded-full"
        onClick={toggleNotifications}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-slate-500 dark:text-navy-100" stroke="currentColor" fill="none" viewBox="0 0 24 24">
      ...
      {isOpen && (
              ...
              <div className="rounded-t-lg bg-slate-100 text-slate-600 dark:bg-navy-800 dark:text-navy-200">
                <div className="flex items-center justify-between px-4 pt-2">
                  ...
                  <button className="btn -mr-1.5 size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                ...
                <div className="tabs is-scrollbar-hidden flex shrink-0 overflow-x-auto px-3">
                  <button className="tab btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5" data-active-class="border-primary dark:border-accent text-primary dark:text-accent-light" data-default-class="border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100" data-target="#notification-all">
                    <span>All</span>
                  </button>
                  <button className="tab btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5" data-active-class="border-primary dark:border-accent text-primary dark:text-accent-light" data-default-class="border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100" data-target="#notification-alerts">
                    <span>Alerts</span>
                  </button>
                  <button className="tab btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5" data-active-class="border-primary dark:border-accent text-primary dark:text-accent-light" data-default-class="border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100" data-target="#notification-events">
                    <span>Events</span>
                  </button>
                  <button className="tab btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5" data-active-class="border-primary dark:border-accent text-primary dark:text-accent-light" data-default-class="border-transparent hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100" data-target="#notification-logs">
                    <span>Logs</span>
                  </button>
                </div>
              </div>
              <div className="flex flex-col overflow-hidden">
                <div className="tab-content tab-shift-left is-scrollbar-hidden space-y-4 overflow-y-auto px-4 py-4" id="notification-all">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-info/10 dark:bg-info/15">
                      <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-info" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-warning/10 dark:bg-warning/15">
                      <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex text-xs text-slate-400 dark:text-navy-300">
                        ...
                        <div className="mx-2 my-1 w-px bg-slate-200 dark:bg-navy-500" />
                        <span className="line-clamp-1">Interview, Konnor Guzman
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div id="notification-alerts" className="tab-content tab-shift-left is-scrollbar-hidden space-y-4 overflow-y-auto px-4 py-4">
                  <div className="flex items-center space-x-3">
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-secondary/10 dark:bg-secondary-light/15">
                      <i className="fa fa-user-edit text-secondary dark:text-secondary-light" />
                    </div>
                ...
                <div id="notification-events" className="tab-content tab-shift-left is-scrollbar-hidden space-y-4 overflow-y-auto px-4 py-4">
                  <div className="flex items-center space-x-3">
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-info/10 dark:bg-info/15">
                      <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-info" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex text-xs text-slate-400 dark:text-navy-300">
                        ...
                        <div className="mx-2 my-1 w-px bg-slate-200 dark:bg-navy-500" />
                        <span className="line-clamp-1">Interview, Jonh Doe
                        </span>
                      </div>
                    </div>
                  </div>
                </div>
                <div id="notification-logs" className="tab-content tab-shift-left is-scrollbar-hidden overflow-y-auto px-4">
                  <div className="mt-8 pb-8 text-center">
                    <img className="mx-auto w-36" src="images/illustrations/empty-girl-box.svg" alt="image" />
                    <div className="mt-5">
        ...
        <button data-toggle="drawer" data-target="#right-sidebar" className="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
          <svg xmlns="http://www.w3.org/2000/svg" className="size-5.5 text-slate-500 dark:text-navy-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
